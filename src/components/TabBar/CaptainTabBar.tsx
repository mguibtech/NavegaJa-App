...
/**
 * TabBar customizada para Capitães
 * Cor: Verde (secondary)
 * Tabs: Dashboard, Operações, Financeiro, Perfil
 */
export function CaptainTabBar({state, descriptors, navigation}: BottomTabBarProps) {
...
function TabItem({isFocused, label, badgeCount, options, onPress}: TabItemProps) {
  ...
  const textColor = isFocused ? 'secondary' : 'textSecondary';
    ...
    <TouchableOpacity
      ...
      <Box alignItems="center">
        ...
        <Box position="relative" mb="s6">
          ...
          {/* Badge de notificação - Dourado (warning) */}
